...
export const applyJobQuery = `INSERT INTO applications (job_id,firstname,lastname,email,phone_number,resume_url,candidat_note,linkedin_url) VALUES ($1, $2, $3, $4, $5, $6, $7) RETURNING id`;
